# Calendário Editorial — Ciclo 1 (jul-out/2026)

**Como funciona:** a rotina diária pega a **primeira linha `PENDENTE`** (de cima pra baixo), produz o artigo e troca o status para `PUBLICADO AAAA-MM-DD + URL` (ou `DRAFT`, ou `DESCARTADA (motivo)`). Para mudar prioridade, reordene as linhas. Título é provisório: o redator pode refinar mantendo a keyword-alvo.

Clusters: TP = tráfego pago e-commerce · SEO = SEO e-commerce · CRO = conversão/gestão · CRM = retenção · LOC = varejo local · DAD = dados/margem · MKT = marketplaces · SAZ = sazonal.
Categorias WP: E-commerce=14, SEO=13, SEO Local=17, Tráfego Pago=15, Marketing Digital=29.
...
| 20 | Como fazer sua loja ser recomendada pelo ChatGPT e pelo AI Overviews | loja recomendada chatgpt ai overviews | SEO | 13 | MOFU | PUBLICADO 2026-07-28 https://www.salestrategias.com.br/loja-recomendada-chatgpt-ai-overviews/ |
| 21 | Drive-to-store: como usar o digital para encher a loja física | drive to store como funciona | LOC | 17 | TOFU | PUBLICADO 2026-07-29 https://www.salestrategias.com.br/drive-to-store-como-funciona/ |
...
| 28 | Títulos de produto no feed: o ajuste que faz o Google Shopping vender mais | otimizar feed google shopping | TP | 15 | MOFU | PUBLICADO 2026-08-05 https://www.salestrategias.com.br/otimizar-feed-google-shopping/ |
...
| 68 | Dia das Crianças (12/10) no varejo: campanha e estoque em 4 semanas | campanha dia das criancas varejo | SAZ | 29 | MOFU | PUBLICADO 2026-09-15 https://www.salestrategias.com.br/campanha-dia-das-criancas-varejo/ |
...
| 71 | Shopee Ads para produto de ticket baixo: a conta fecha? | shopee ads compensa | MKT | 14 | MOFU | PENDENTE |
| 72 | GA4 atribuindo vendas ao checkout: como corrigir o referral | ga4 atribuindo venda ao checkout | DAD | 29 | MOFU | PENDENTE |
| 73 | Performance Max para Metas da Loja: o anúncio que traz gente até a porta | performance max metas da loja | LOC | 15 | MOFU | PENDENTE |
| 74 | Precificação na Black Friday sem destruir a margem | precificação black friday | SAZ | 14 | MOFU | PENDENTE |
| 75 | Estrutura de campanhas Google Ads para e-commerce: simples e escalável | estrutura campanha google ads e-commerce | TP | 15 | MOFU | PENDENTE |
| 76 | Ferramenta de e-mail/CRM para loja pequena: comparativo honesto de custos | ferramenta email marketing loja virtual preço | CRM | 14 | MOFU | PENDENTE |
| 77 | Blog para e-commerce vale a pena? Quando sim, quando não | blog para e-commerce vale a pena | SEO | 13 | MOFU | PENDENTE |
| 78 | Pop-up de saída: funciona ou só irrita o cliente? | pop up de saida funciona | CRO | 14 | TOFU | PENDENTE |
| 79 | Instagram Shopping: como configurar a sacolinha da sua loja | instagram shopping como configurar | MKT | 14 | MOFU | PENDENTE |
| 80 | Reta final do ano no varejo: recalibrando a mídia do 4º trimestre | planejamento midia quarto trimestre varejo | SAZ | 29 | MOFU | PENDENTE |
| 81 | Como aumentar o LTV da loja: as 4 alavancas de quem não vende assinatura | como aumentar ltv e-commerce | CRM | 14 | MOFU | PENDENTE |
| 82 | Datas locais e regionais: o calendário que o comércio de bairro esquece | datas comemorativas comercio local | LOC | 17 | TOFU | PENDENTE |
| 83 | Estratégia de lance no Google Ads: CPC, maximizar conversões ou ROAS-alvo | estrategia de lance google ads | TP | 15 | MOFU | PENDENTE |
| 84 | Alt text e imagens de produto: o SEO que quase ninguém faz | alt text imagem de produto | SEO | 13 | MOFU | PENDENTE |
| 85 | Esquenta Black Friday: como aquecer a audiência sem queimar a oferta | esquenta black friday como fazer | SAZ | 14 | MOFU | PENDENTE |
| 86 | Feed de produtos na era da IA: seu catálogo é o novo vendedor | feed de produtos ia | SEO | 13 | TOFU | PENDENTE |
| 87 | Kits presenteáveis: como montar e precificar para as datas do fim de ano | kit de produtos como montar | CRO | 14 | MOFU | PENDENTE |
| 88 | Campanha de Natal para loja virtual: cronograma de outubro a dezembro | campanha de natal loja virtual | SAZ | 14 | MOFU | PENDENTE |
| 89 | Depender só de marketplace é arriscado? O plano do canal próprio | depender so de marketplace | MKT | 14 | TOFU | PENDENTE |
| 90 | Como vender no TikTok Shop: do cadastro à primeira venda | como vender no tiktok shop | MKT | 14 | MOFU | PENDENTE |

## Reservas para o Ciclo 2 (gerar quando restarem <10 PENDENTE)

Black Friday reta final (checklist da semana, remarketing pós-BF, análise de resultados), Natal reta final, retrospectiva e planejamento 2027, atualização anual dos posts de datas, aprofundamentos dos artigos que mais performarem no GSC.
