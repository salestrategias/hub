...
**Menu:** Serviços · Para quem · Método · A SAL · Blog
`>> AJUSTE:`

**Botão do topo:** Agendar diagnóstico ↗
`>> AJUSTE:`

---

## 2. Primeira dobra (o que a pessoa vê em 3 segundos)
...
**Botões:**
1. Agendar diagnóstico ↗
2. Ver como trabalhamos
...
## 4. Para quem a SAL trabalha

**Título:** Dois negócios, duas engrenagens diferentes.
`>> AJUSTE:`

**Apoio:** Loja de rua e loja online não vendem do mesmo jeito, e o marketing das duas não pode ser o mesmo. A SAL trabalha as duas, com a dose que cada uma pede.
`>> AJUSTE:`
...
- Rede: cada loja com o seu perfil, sua página e seu painel
`>> AJUSTE:`

**Card 2 — E-commerce**
Loja virtual que precisa crescer com margem, e não só aumentar o número de pedidos.
- Shopping, Performance Max e catálogo bem configurados
- Meta de retorno calculada sobre comissão, frete e imposto
- Produto e categoria ranqueando sem pagar por clique
- Sua marca citada nas respostas do ChatGPT e do Gemini
`>> AJUSTE:`
...
*Agora são 6, e os dois de SEO abrem a lista, com destaque visual.*

**Título:** O que a SAL entrega, na prática.
`>> AJUSTE:`

**1. SEO local** — Perfil da Empresa no Google, mapa e busca de bairro. Quem pesquisa "perto de mim" precisa achar a sua loja antes de achar a do vizinho. Em rede, cada unidade tem o seu.
`>> AJUSTE:`

**2. SEO para e-commerce** — Categoria, produto e conteúdo ranqueando para quem já está decidido a comprar. Inclui o trabalho para a sua marca ser citada nas respostas do ChatGPT, do Gemini e do Google.
`>> AJUSTE:`
...
**02 Desenhar** — Verba, canais, metas e calendário definidos antes de qualquer campanha ir para o ar, com base no seu ticket e na sua margem.
`>> AJUSTE:`

**03 Disparar** — Gestão diária das campanhas, criativo novo toda semana e o SEO avançando mês a mês, com ajuste enquanto roda.
`>> AJUSTE:`

**04 Decodificar** — Reunião mensal lendo os números juntos. Canal que não se paga sai do plano no mês seguinte.
`>> AJUSTE:`

---

## 7. Os três territórios da venda *(bloco novo, que você aprovou)*

**Título:** Os três territórios da venda.
`>> AJUSTE:`

**Apoio:** Toda venda, na loja de rua ou no e-commerce, passa por três momentos. A maior parte das agências trabalha só o primeiro. É no segundo e no terceiro que costuma estar o dinheiro que a sua operação já poderia estar fazendo.
`>> AJUSTE:`

**01 Ser encontrado** — SEO local, SEO de e-commerce, Perfil da Empresa no Google, presença nas respostas das IAs e anúncio na hora da busca. Antes de convencer alguém, é preciso aparecer para essa pessoa.
`>> AJUSTE:`

**02 Ser escolhido** — Página de produto, checkout, oferta, avaliações e criativo. Quem chega até você compara com outros três antes de decidir, e o que decide é o que está na tela nesses segundos.
`>> AJUSTE:`

**03 Ser lembrado** — Base de clientes, WhatsApp, recompra e sazonalidade. Cliente que comprou uma vez e nunca mais ouviu falar de você custou caro duas vezes.
`>> AJUSTE:`
...
Tráfego pago é quando você paga por clique ou impressão, no Google Ads e no Meta Ads: liga hoje, traz visita hoje, e para quando a verba acaba. Tráfego orgânico vem do SEO, das buscas, do mapa e das respostas das IAs: demora mais pra engrenar e não some quando você para de investir. Os dois se completam, e o que muda de loja pra loja é a dose de cada um.
`>> AJUSTE:`

**2. Quanto preciso investir em anúncios para começar?** *(com os seus números)*
Para e-commerce, trabalhamos com quem tem pelo menos R$ 2.000 por mês para investir em anúncios. Para loja física, R$ 1.500. Abaixo disso a campanha não reúne dado suficiente para otimizar e o dinheiro rende mais em outra frente, normalmente no SEO local. Se for o seu caso, a gente diz isso no diagnóstico.
`>> AJUSTE:`
...
As duas. Metade do trabalho é com loja física, quiosque, franquia e operação em shopping, onde o objetivo é fluxo na porta. A outra metade é e-commerce. Quem tem os dois canais recebe um plano que cobre os dois.
`>> AJUSTE:`

**5. Vocês atendem rede com várias lojas?** *(pergunta nova)*
...
**Título:** Vamos olhar a sua operação?
`>> AJUSTE:`

**Texto:** Escolha um horário e a gente analisa suas contas de anúncio, sua presença no mapa e a sua concorrência. Você sai com as prioridades na mão, com ou sem proposta depois.
`>> AJUSTE:`

**Botão:** Agendar diagnóstico ↗
**Garantias:** ✓ Resposta em até 1 dia útil · ✓ Diagnóstico sem custo · ✓ Sem compromisso
`>> AJUSTE:`
...
**Colunas:**
- Serviços: Tráfego pago · SEO e tráfego orgânico · Varejo local · E-commerce
- A SAL: Quem somos · Marcelo Freitas · Blog da SAL · Materiais gratuitos
- Começar: Agendar diagnóstico · Contratar a SAL · WhatsApp · Instagram
`>> AJUSTE:`
