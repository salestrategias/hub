/**
 * POST /api/posts/[id]/revisar
 *
 * Marcelo revisa um post submetido pelo cliente (origem=CLIENTE).
 * Body: { decisao: "APROVADO" | "AJUSTE", nota?: string }
 *  - APROVADO → revisao=APROVADO, revisaoNota limpa. O post permanece no
 *    pipeline normal (status RASCUNHO) pra Marcelo trabalhar nele.
