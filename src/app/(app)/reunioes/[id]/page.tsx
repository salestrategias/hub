...
export default async function ReuniaoDetalhePage({ params }: { params: { id: string } }) {
  const [reuniao, leads] = await Promise.all([
    ...
    >
      <ReuniaoDetalhe
        reuniao={{
          ...
          actions: reuniao.actionItems.map((a) => ({ id: a.id, texto: a.texto, responsavel: a.responsavel, prazo: a.prazo, concluido: a.concluido, tarefaId: a.tarefaId })),
